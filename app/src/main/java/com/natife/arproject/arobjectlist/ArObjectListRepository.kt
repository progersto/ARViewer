...
class ArObjectListRepository: ArObjectListContract.Repository {
    ...
    override fun initList(){
        ...
        listFolder.add(Model(null, Model.FOLDER_TYPE, "folder 2", null, null, 1))
        listFolder.add(Model(null, Model.FOLDER_TYPE, "folder 3", null, null, 1))
        listFolder.add(Model(null, Model.FOLDER_TYPE, "folder 4", null, null, null))

        listImage = java.util.ArrayList()
        listImage.add(Model(null, Model.IMAGE_TYPE, "model", R.drawable.model, "model.sfb", 1))
        listImage.add(Model(null, Model.IMAGE_TYPE, "tricycle", R.drawable.tricycle, "tricycle.sfb", 1))
        listImage.add(Model(null, Model.IMAGE_TYPE, "uranus", R.drawable.uranus, "Uranus.sfb", 1))
        listImage.add(Model(null, Model.IMAGE_TYPE, "model2", R.drawable.model2, "model2.sfb", 1))
        ...
        listImage.add(Model(null, Model.IMAGE_TYPE, "chair", R.drawable.chair, "Chair2.sfb", 1))
